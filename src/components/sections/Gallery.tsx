...
const galleryImages: GalleryItem[] = [
  ...
  },
  {
    ...
    category: "doctors",
    info: "Gynecology | 12+ Years Experience",
    icon: Baby,
  ...
  },
  {
    ...
    category: "hospital",
    info: "Comprehensive Healthcare",
    icon: Building2,
    name: "Our Healthcare Services",
    description: "Comprehensive healthcare services including 24/7 emergency care, diagnostics laboratory, and specialized treatments at Sri Suraksha Multi Speciality Hospital.",
  },
  {
    src: "/images/facility2.png",
    alt: "Patient Consultation",
    category: "hospital",
    info: "Doctor Consultation Room",
    icon: Building2,
    name: "Consultation & Treatment",
    description: "Modern consultation rooms where our experienced doctors provide personalized care and treatment plans for every patient.",
  },
  {
  ...
  },
  {
    ...
    alt: "Hospital Reception Counter",
    category: "hospital",
    info: "Reception & ECG Wing",
    icon: Building2,
    name: "Reception & ECG Counter",
    description: "Our hospital reception counter with dedicated ECG diagnostic services, where patients are attended by our friendly staff for smooth check-in and consultations.",
    location: "Sri Suraksha Multi Speciality Hospital, Metpally",
  },
  {
