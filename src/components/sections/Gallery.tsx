...
const galleryImages: GalleryItem[] = [
  {
    ...
    description:
      "An experienced physician specializing in internal medicine, chronic disease management, and comprehensive health evaluations. Known for accurate diagnoses and compassionate patient care.",
    availability: "Available 24/7",
    location: "General Medicine Wing",
    rating: 4.9,
  },
  {
    ...
    experience: "12+ Years Experience",
    description:
      "An experienced gynecologist specializing in women's health, prenatal care, menstrual health management, fertility consultations, and comprehensive gynecological treatments.",
    availability: "Available 24/7",
