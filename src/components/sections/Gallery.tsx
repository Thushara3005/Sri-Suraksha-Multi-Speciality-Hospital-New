...
const galleryImages: GalleryItem[] = [
  {
    ...
    category: "doctors",
    info: "General Medicine & Gynecology | 12+ Years Experience",
    icon: Stethoscope,
    name: "Our Specialists",
    specialty: "General Medicine & Gynecology",
    qualifications: "MBBS, MD (General Medicine) & MBBS, MS (OBG)",
    experience: "12+ Years Experience",
    description:
      "Our team of experienced specialists includes a General Medicine physician and a Gynecologist, each with over 12 years of clinical expertise. Together they provide comprehensive healthcare including general consultations, women's health, prenatal care, and chronic disease management.",
  ...
  },
  {
    ...
    alt: "Sri Suraksha Hospital Building",
    category: "hospital",
    info: "Hospital Building - Metpally",
    icon: Building2,
    name: "Sri Suraksha Multi Speciality Hospital",
    description: "Our modern hospital building in Metpally, Telangana, equipped with advanced medical facilities and diagnostic laboratory.",
    location: "Metpally, Jagtial District, Telangana",
  },
  {
    src: "/images/facility1.png",
    alt: "Inpatient Ward",
    category: "hospital",
    info: "Inpatient Care Facility",
    icon: Building2,
    name: "Inpatient Ward",
    description: "Well-equipped inpatient ward with comfortable facilities for patient recovery and continuous medical monitoring.",
  },
  {
    src: "/images/facility2.png",
    alt: "Waiting Area",
    category: "hospital",
    info: "Patient Waiting Area",
    icon: Building2,
    name: "Waiting & Reception Area",
    description: "Comfortable waiting area with a welcoming reception for patients and visitors.",
  },
];
